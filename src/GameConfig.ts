...
export const ENEMIES: Record<EnemyType, EnemyDef> = {
  blue:   { type: 'blue',   name: 'Pixel',      hp: 80,  speed: 90,  reward: 10, bonusPoints: 0, color: 0x00ffff, size: 11 },
  red:    { type: 'red',    name: 'Virus',      hp: 130, speed: 65,  reward: 15, bonusPoints: 0, color: 0xff0088, size: 13 },
  green:  { type: 'green',  name: 'Glitch',     hp: 165, speed: 55,  reward: 20, bonusPoints: 0, color: 0x00ff00, size: 15 },
  yellow: { type: 'yellow', name: 'Spark',      hp: 60,  speed: 145, reward: 12, bonusPoints: 0, color: 0xffff00, size: 11 },
  purple: { type: 'purple', name: 'Nova',       hp: 225, speed: 42,  reward: 25, bonusPoints: 0, color: 0xaa00ff, size: 16 },
  grey:   { type: 'grey',   name: 'Core',       hp: 700, speed: 30,  reward: 50, bonusPoints: 5, color: 0xff00ff, size: 20 },
};
